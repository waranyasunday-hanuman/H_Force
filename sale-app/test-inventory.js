...
async function runTest() {
    try {
        ...
        console.log("Fetching Inventory Balance...");
        const endpoints = [
            "/InventoryBalance/ViewListInventoryBalanceStatus",
            "/InventoryBalance/GetListInventoryBalanceStatus",
            "/Inventory/GetListInventoryBalanceStatus",
            "/Inventory/ViewListInventoryBalanceStatus",
            "/InventoryBasic/GetListInventoryBalanceStatus",
            "/InventoryBalance/GetInventoryBalanceStatusList",
            "/Inventory/GetInventoryBalanceStatusList",
            "/Inventory/GetListInventoryBalance"
        ];
